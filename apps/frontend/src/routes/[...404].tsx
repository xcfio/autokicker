...
export default function NotFound() {
    ...
    return (
        <>
            <div class="min-h-screen bg-linear-to-br from-blue-900 via-teal-900 to-blue-900 flex items-center justify-center p-4 overflow-hidden relative">
                ...
                <div
                    class={`text-center flex flex-col gap-8 md:gap-6 relative z-10 transition-all duration-1000 ease-out ${
                ...
                >
                    ...
                    <div class="relative">
                        <h1
                            class={`text-404 text-[clamp(4rem,15vw,9rem)] font-black text-white tracking-widest m-0 relative transition-all duration-200 ${
